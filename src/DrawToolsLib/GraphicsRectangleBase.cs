...
namespace DrawToolsLib
{
    ...
    public abstract class GraphicsRectangleBase : GraphicsBase
    {
        ...
        protected double? overrideRectangleWidth;
        protected double? overrideRectangleHeight;
        ...
        public Rect Rectangle
        {
            get
            {
                ...
                var setVerticalOffset = false;
                var setHorizontalOffset = false;
                ...
                if (this.overrideRectangleHeight.HasValue)
                {
                    var oldH = h;
                    h = this.overrideRectangleHeight.Value;
                ...
                if (this.overrideRectangleWidth.HasValue)
                {
                    var oldW = w;
                    w = this.overrideRectangleWidth.Value;
        ...
        {
            var xCenter = (this.rectangleRight + this.rectangleLeft) / 2;
            var yCenter = (this.rectangleBottom + this.rectangleTop) / 2;
            var x = this.rectangleLeft;
            var y = this.rectangleTop;
        ...
        {
            this.overrideRectangleHeight = null;
            this.overrideRectangleWidth = null;

            if (Keyboard.Modifiers == ModifierKeys.Shift)
            {
                var measure = Math.Min(this.Rectangle.Width, this.Rectangle.Height);

                this.overrideRectangleHeight = measure;
                this.overrideRectangleWidth = measure;
            }
